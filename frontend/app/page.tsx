              ...
              <div className="p-6">
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <Input
                      type="text"
                      placeholder="e.g., /host-root/mnt/data"
                      value={selectedDirectory}
                      onChange={(e) => setSelectedDirectory(e.target.value)}
                      className="border-2 border-gray-200 hover:border-blue-300 focus:border-blue-500 transition-colors font-medium shadow-sm"
                    />
